...
vlog -quiet -sv -work ${LIB_NAME} +incdir+${TB_PATH} +incdir+${RTL_PATH}/includes ${ASIC_DEFINES} ${TB_PATH}/tb.sv               || goto error
...
# 
vlog -quiet -sv -work ${LIB_NAME} ${ASIC_DEFINES} +incdir+${TB_PATH} +incdir+${RTL_PATH}/includes/ -dpiheader ${TB_PATH}/mem_dpi/dpiheader.h    ${TB_PATH}/tb.sv || goto error
